...
<head>
    <head>
        ...
        <link href="<?php echo base_url('assets/tampilan/bootstrap/css/bootstrap.min.css')?>" rel="stylesheet">
        <link href="<?php echo base_url('assets/tampilan/bootstrap/css/bootstrap-responsive.min.css')?>" rel="stylesheet">
        <link href="<?php echo base_url('assets/tampilan/css/theme.css')?>" rel="stylesheet">
        <link href="<?php echo base_url('assets/tampilan/images/icons/css/font-awesome.css')?>" rel="stylesheet">
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li class="active"><a href="<?php echo site_url('person'); ?>"><i></i>Data Pelayan
                                </a></li>
                                <li><a href="<?php echo site_url('menu'); ?>"><i></i>Daftar Menu </a>
                                </li>
								<li class="active"><a href="index.html"><i></i>Laporan Penjualan
                                </a></li>
                            ...
                            <div class="module">
                                ...
                                <div class="module-body">
                                    <div class="chart inline-legend grid">
										...
										<button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Tambah Pelayan</button>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="no_hp" placeholder="no_hp" class="form-control" type="text" >
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="tgl_lahir" placeholder="yyyy-mm-dd" class="form-control datepicker" type="date">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
...
function edit_person(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="alamat"]').val(data.lastName);
            $('[name="jenis_kelamin"]').val(data.jenis_kelamin);
            $('[name="no_hp"]').val(data.address);
