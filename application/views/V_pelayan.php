...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
            ...
            <a class="brand" href="<?php echo site_url('pelayan')?>">
                Pelayan
            </a>
...
<script type="text/javascript">
    ...
    function showBarang(str)
    {
        ...
        if (str == "") {
            ...
            xmlhttp.open("GET", "<?= base_url(
                    'index.php/m_pelayan/getbarang') ?>/"+str,true);
            xmlhttp.send();
        }
    }
    ...
    $(document).ready(function() {
        ...
        table = $('#table_transaksi').DataTable({
            ...
            "ajax": {
                "url": "<?= site_url('m_pelayan/ajax_list_transaksi')?>"
            },
    ...
    function addmenu()
    {
        ...
        if (id_barang == '') {
            ...
            $.ajax({
                url : "<?= site_url('m_pelayan/addmenu')?>",
                type: "POST",
    ...
    function deletemenu(id,sub_total)
    {
        // ajax delete data to database
        $.ajax({
            url : "<?= site_url('m_pelayan/deletemenu')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
